...
export function NavigationMenuALX() {
  return (
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem>
          <Link href={WEBSITE_ROUTES.HOME_PAGE} legacyBehavior passHref>
        ...
        <NavigationMenuItem>
          <Link href={WEBSITE_ROUTES.ABOUT_PAGE} legacyBehavior passHref>
            <NavigationMenuLink className={navigationMenuTriggerStyle()}>
              About
            </NavigationMenuLink>
          </Link>
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] ">
              {navigationInformation.map(component => (
                <ListItem
                  key={component.title}
